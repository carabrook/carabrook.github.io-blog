...
### Without internet access - this will have to wait until tomorrow! Azafady!
...
2. To start, we recommend only downloading the tar.gz files into your library. If you have problems you can then try downloading the .zip versions of each package, but hopefully, the tar.gz will work on the first try.
