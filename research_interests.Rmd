...
<img src="bat_cell_model.png" alt="bat_cell" style="height: 300px; padding-right: 10px;" align="left"><div style="text-align: left; font-size: 1.2em; padding-right=100px">Recent work has demonstrated that some species of Old World Fruit Bat constitutively express the cytokine, Interferon-alpha, meaning that they have perpetually-primed antiviral immune systems ([Zhou et al. 2016](http://www.pnas.org/content/113/10/2696)). This unique immunity likely plays a role in bats' capacities to resist or tolerate viral infections that cause extreme virulence in other mammalian hosts. As a graduate student, I studied the dynamics of bat viruses *in vitro*, modeling the spread of infection across a monolayer of bat cells under differing assumptions of innate antiviral immune status. We found that resident infections established under constitutive immune assumptions generated parameter estimates for within-host viral propagation rates a full order of magnitude higher than those estimated under conventional, induced immune assumptions. Such findings suggest that viruses evolved in perpetually antiviral immune systems--like those demonstrated for bats--may achieve elevated replication rates likely to cause extreme pathology upon emergence into a host lacking constitutive immune defenses.
<br>
<br>
As a Miller Fellow, I am exploring the impact of a generalist anti-viral immune systems on the evolution of viral virulence, using a theoretical, adaptive dynamics approach.
</div>

---

<div style="text-align: left; font-size: 1em;">
**Brook CE**, Ng M, Boots M, Dobson A, Graham A, Grenfell B, Chandran KC, van Leeuwen A. In Revision. Within-host dynamics of virulent viruses in bat reservoirs for emerging zoonotic disease. eLife. doi (preprint): [10.1101/696195](https://doi.org/10.1101/696195).
</div>
